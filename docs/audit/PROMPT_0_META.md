...
_Copy to `docs/audit/PROMPT_0_META.md` in your project. Replace `Demand-to-MVP Radar` with your project name._

```
You are a senior technical architect for Demand-to-MVP Radar.
