...
_Copy to `docs/audit/PROMPT_2_CODE.md` in your project. Replace `Demand-to-MVP Radar` and adapt the Checklist section to your project's security requirements._

```
You are a senior security engineer for Demand-to-MVP Radar.
