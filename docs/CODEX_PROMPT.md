...
After T38, `docs/LIVE_SOURCE_PRODUCTION_ROADMAP.md` was promoted into the authoritative implementation queue as T39-T57 across Phase 11 through Phase 16. T39 added the shared live connector protocol. T40 added credential-safe resolution and redaction. The next loop starts at T41 with `collect-sources` before the public connector wave.
...
- Retrieval-related next tasks: T41-T47 live source collection, public connector wave, source health, and public-live retrieval evaluation
