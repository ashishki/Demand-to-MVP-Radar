# Demand-to-MVP Radar — Workflow Orchestrator
...
Run: cd /home/ashishki/Documents/dev/ai-stack/projects/Demand-to-MVP-Radar && pytest tests/ -q
...
4. Run ruff check demand_mvp_radar/ tests/ → zero errors
...
Run: cd /home/ashishki/Documents/dev/ai-stack/projects/Demand-to-MVP-Radar && pytest tests/ -q — must be green.
...
<!-- no external notification configured is optional. It represents any out-of-band notification
...
Notification delivery (adapt or remove for no external notification configured):
```bash
